...
// 调用后台JS
$('#invoke_background_js').click(function () {
    var bg = chrome.extension.getBackgroundPage();
    bg.testBackground();
});

// 获取后台页标题
$('#get_background_title').click(function () {
    var bg = chrome.extension.getBackgroundPage();
    alert(bg.document.title);
});

// 设置后台页标题
$('#set_background_title').click(function () {
...
// 自定义窗体大小
$('#custom_window_size').click(function () {
...
// 最大化窗口
$('#max_current_window').click(function () {
    chrome.windows.getCurrent({}, function (currentWindow) {
...
// 最小化窗口
$('#min_current_window').click(function () {
    chrome.windows.getCurrent({}, function (currentWindow) {
        // state: 可选 'minimized', 'maximized' and 'fullscreen'
...
// 关闭全部
$('#close_current_window').click(function () {
    chrome.windows.getCurrent({}, function (currentWindow) {
...
// 新标签打开网页
$('#open_url_new_tab').click(function () {
    chrome.tabs.create({url: 'https://www.baidu.com'});
});

// 当前标签打开网页
$('#open_url_current_tab').click(function () {
...
// 获取当前标签ID
$('#get_current_tab_id').click(function () {
    getCurrentTabId(function (tabId) {
        alert('当前标签ID：' + tabId);
    });
});
...
$('#send_message_to_content_script').click(function () {
...
$('#connect_to_content_script').click(function () {
    getCurrentTabId(function (tabId) {
...
// 修改字体大小
$('#update_font_size').click(function () {
