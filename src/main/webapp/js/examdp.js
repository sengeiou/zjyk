...
function loadBaseInfo() {
    new QRCode(document.getElementById("qrcode"), "http://k12-eco.com/zjyk/examkq/" + record.id);
    $('#studentName').text(record.studentName + '(考情分析)');
    $('#paperName').text(record.paper.name);

    document.getElementById("noteAll").value = record.noteAll ? record.noteAll : '';
    document.getElementById("noteTypeLossScore").value = record.noteType ? record.noteType : '';
    document.getElementById("notePointLossScore").value = record.notePoint ? record.notePoint : '';
    document.getElementById("noteDifficultyLossScore").value = record.noteDifficulty ? record.noteDifficulty : '';
    document.getElementById("noteErrorTypeLossScore").value = record.noteErrorType ? record.noteErrorType : '';
    document.getElementById("noteOffer").value = record.noteOffer ? record.noteOffer : '';
}

function saveNote() {
    var formData = new FormData();
    formData.append("id", record.id);
    formData.append("noteAll", document.getElementById("noteAll").value);
    formData.append("noteType", document.getElementById("noteTypeLossScore").value);
    formData.append("notePoint", document.getElementById("notePointLossScore").value);
    formData.append("noteDifficulty", document.getElementById("noteDifficultyLossScore").value);
    formData.append("noteErrorType", document.getElementById("noteErrorTypeLossScore").value);
    formData.append("noteOffer", document.getElementById("noteOffer").value);
    $.post({
        url: '../examrecord/savedp',
