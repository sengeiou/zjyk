...
public class LOGJson
{
	...
	private static String getStrImpl(String jsonStr, int limit, boolean withBr)
	{
		try
		{
			...
			traversal(jsonStr, limit, new TraversalCallback()
			{
				...
				public void callback(String line)
				{
					...
					if (withBr)
					{
						os.write("<br />".getBytes(Charset.forName("UTF-8")), 0, "<br />".getBytes(Charset.forName("UTF-8")).length);
					}
				}
			});
			os.close();
	...
	{
		return getStrImpl(jsonStr, limit, false);
	}

	public static String getStr(String jsonStr)
	{
		return getStrImpl(jsonStr, Integer.MAX_VALUE, false);
	}

	public static String getStr(String jsonStr, boolean withBr)
	{
		return getStrImpl(jsonStr, Integer.MAX_VALUE, withBr);
	}
